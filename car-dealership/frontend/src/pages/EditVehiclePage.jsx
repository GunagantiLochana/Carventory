      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-slate-500">
            Update the vehicle details and inventory quantity.
          </p>
        </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                <label htmlFor="make" className="mb-2 block text-sm font-semibold text-slate-700">
                  Make
                </label>
                <input
                  id="make"
                  ...
                  className="w-full rounded-lg border border-slate-300 px-4 py-3 text-slate-900 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                />
              </div>

              <div>
                <label htmlFor="model" className="mb-2 block text-sm font-semibold text-slate-700">
                  Model
                </label>
                <input
                  id="model"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={form.price}
                    onChange={handleChange}
                    className="w-full rounded-lg border border-slate-300 py-3 pl-8 pr-4 text-slate-900 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                  />
                </div>
              </div>
